    ...
    <div className="min-h-screen">
      ...
      <div className="block md:hidden px-4 py-6 space-y-6">
        ...
        <div className="pt-4">
          <button
            onClick={() => signOut({ callbackUrl: '/' })}
            className="w-full rounded-full border border-white/20 bg-white/10 px-5 py-3 text-sm font-semibold text-white backdrop-blur-2xl shadow-2xl hover:bg-white/20 transition"
          >
            Выйти
          </button>
        </div>
